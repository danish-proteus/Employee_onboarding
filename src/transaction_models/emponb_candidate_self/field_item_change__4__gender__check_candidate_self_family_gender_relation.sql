...
field_name: gender
language: plpgsql
description: Validate gender/relation consistency on GENDER change
...
business_logic: Validate gender/relation consistency on GENDER change
*/
...
DECLARE
    ...
    v_relation text := p->>'RELATION';  -- family relation
BEGIN
